...
<body>
        <div style="display:flex; height: 80vh; width: 50vw; background-color: pink; flex-direction: column; justify-content: space-between; align-items:center ; align-content: space-between;border-radius:0px;">
        ...
        <div id="lower" style="display:inline-flex; margin-left:130px; flex-direction: row; align-content;justify-content: space-between;
...
<body>
    <div id="main" style="display: flex; flex-direction: column;align-content: space-between; height: 50vh; width: 40vw; justify-content: space-between; background-color: pink;border-radius:0px;">
...
<body>
    <div id="main" style="height: 40vh; width: 40vw; background-color:pink;display: flex; flex-direction: column;align-items: center;justify-content: space-between;border-radius:0px;padding-top:40px;margin-left:80px;">
...
<body>
    <div id="main" style="Background-color:white;padding-left:30px">
        ...
        <div id="lower" style="padding-top:20px ;">
            <table border="3px solid black;" style="float:right;Background-color:white;position:abosolute;">
                ...
                <tr>
                    ...
                    <td>Tamilnadu</td>
                    <td>20</td>
                    <td>its.roshniakula@gmail.com</td>
                    <td>26-09-2022</td>
                    <td>Savings</td>
                    <td>83000</td>
                </tr>
...
<body>
    <div id="main" style="display: flex; flex-direction: column;align-content: space-between; height: 40vh; width: 50vw; justify-content: space-between; background-color: pink;padding-top:30px;border-radius:0px;">
...
<body>
    <div id="main" style="height: 50vh; width: 60vw; background-color:pink;display: flex; flex-direction: column;align-items: center;justify-content: space-between;border-radius:0px;padding-top:40px;margin-left:80px">
        <div><span id="accountnumber" style="color: white; font-size: 4vh;">Account number</span>
        <span id="input"><input type="text" placeholder="Account number" style="height:30px;font-size:2.5vh"></span>
    </div>
...
<body>
    <div id="main" style="height: 20vh; width: 40vw; background-color:pink;display: flex; flex-direction: column;align-items: center;justify-content: space-between;border-radius:0px;padding-top:40px;margin-left:80px">
        <div><span id="accountnumber" style="color: white; font-size: 4vh;">Account number</span>
        <span id="input"><input type="text" placeholder="Account number"style="height:30px;font-size:2.5vh"></span>
        </div>
